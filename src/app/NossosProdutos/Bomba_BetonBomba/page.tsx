      ...
      <div className='grid lg:grid-cols-2 grid-cols-1 ml-9 lg:ml-0 gap-12'>
        ...
        <div className='mt-12'>
          ...
          <ul className='ml-0 mt-6'>
            <li className='flex text-xl'><span className='pr-2'><TiInputChecked size={25} /></span>200 bar de pressão
            </li>
            <li className='flex text-xl'><span className='pr-2'  ><TiInputChecked size={25} /></span>Camisa 180 de diâmetro
            </li>
            <li className='flex text-xl'><span className='pr-2'  ><TiInputChecked size={25} /></span>0.75 de comprimento
            </li>
            <li className='flex text-xl'><span className='pr-2'  ><TiInputChecked size={25} /></span>Pistão 0.75 de comprimento
            </li>
            <li className='flex text-xl'><span className='pr-2 ' ><TiInputChecked size={25} /></span>Potência equivalente a P500
            </li>
            <li className='flex text-xl'><span className='pr-2'  ><TiInputChecked size={25} /></span>Bombeamento horizontal 100 metros
            </li>
            <li className='flex text-xl'><span className='pr-2'  ><TiInputChecked size={25} /></span>20 metros vertical
            </li>
