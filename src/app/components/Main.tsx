          ...
          <div className='flex lg:flex-row flex-col m-auto justify-center gap-44 lg:ml-32'>
            <div className='max-w-4xl lg:mt-32 mt-8 ml-3'>
              <div className='lg:w-[510px]'>
                <h1 className='text-gray-50 lg:text-4xl text-2xl'><span className='text-blue-400'>Bomba de Concreto de Alta Performance</span>: Elevando o Padrão da sua Construção!</h1>
                <p className='text-gray-50 lg:pt-8 pt-8 w-80 lg:w-[470px]'>A transformação começa aqui! Com nossa Bomba de Concreto, da base ao acabamento, asseguramos a excelência para uma construção segura e duradoura.</p>
              </div>
              <ButtonEncomendar />
              <div>
                <Link href="/img/Catálogo Arrudas_Bombas.pdf" target='_blank'>
