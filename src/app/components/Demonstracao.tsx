...
function Demonstracao() {
  return (
    <section>
      <div className='max-w-4xl m-auto lg:mt-28 -mt-12 flex lg:flex-row flex-col gap-40'>
        <div className='lg:w-[400px] text-center'>
          ...
          <p className='lg:w-[450px] pt-12 w-[370px] ml-4 pl-2 pr-2 lg:-ml-5 lg:pl-0 lg:pr-0'>Somo uma empresa especializada na <span className='text-blue-500'>fabricação de bombas de
        ...
        <div>
          <div className=''>
            <div className='lg:w-[620px] w-[340px] ml-7 lg:ml-0'>
              <Image
