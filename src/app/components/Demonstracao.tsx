    ...
    <section>
      <div className='max-w-4xl m-auto lg:mt-28 flex lg:flex-row flex-col gap-60'>
        <div className='lg:w-[400px] text-center'>
          <h1 className='lg:text-4xl '><span className='text-blue-500'>EXCELÊNCIA GARANTIDA</span> BOMBAS DE CONCRETO PARA OBRAS DE QUALIDADE</h1>
          <p className='pt-12 text-2xl'>Bomba de Concreto</p>
          <p className='lg:w-[450px] pt-12 w-96 ml-4 pl-2 pr-2 lg:pl-0 lg:pr-0'>Somo uma empresa especializada na <span className='text-blue-500'>fabricação de bombas de
